  ...
  return (
    <>
      <Routes>
        ...
        <Route
          exact
          path="/nologin/loginsignupfoodbank"
          element={
            <>
              <NavbarNoLogIn />
              <LoginSignupNonProfit />
            </>
          }
        />
        <Route
          exact
          path="/nologin/loginsignuprestaurant"
          element={
            <>
              <NavbarNoLogIn />
